...
ShowNotification('~r~You need to unrack your to use it')
...
RegisterCommand('unrack', function ()
  ...
  if doeshaverifle == false then
      ...
      GiveWeaponComponentToPed(GetPlayerPed(-1), 4208062921, "COMPONENT_AT_AR_FLSH") GiveWeaponComponentToPed(GetPlayerPed(-1), 4208062921, "COMPONENT_AT_AR_AFGRIP_02") GiveWeaponComponentToPed(GetPlayerPed(-1), 4208062921, "COMPONENT_AT_SIGHTS")
...
RegisterCommand('unrack1', function ()
  ...
  if doeshaveshotguh == false then
      ...
      ShowNotification('~g~ '..config.weapon2name..' unracked')

      doeshaveshotguh = true
      GiveWeaponToPed(GetPlayerPed(-1), config.weapon2, 1000, false) 
      GiveWeaponComponentToPed(GetPlayerPed(-1), 1432025498, "COMPONENT_AT_AR_FLSH") GiveWeaponComponentToPed(GetPlayerPed(-1), 1432025498, "COMPONENT_AT_SIGHTS")
